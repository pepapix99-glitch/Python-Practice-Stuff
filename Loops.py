...
#====================================================
'>>NOTE<<'
# all these coded are not meant to work all together, they all just fall under the topic of Loops in Python.
# each topic is separated to be tried out individually
